...
workflow {
    ...
    log.info "nf-diffbind starting..."
    log.info "  project_folder   : ${params.project_folder}"
    log.info "  samplesheet      : ${params.samplesheet}"
    log.info "  diffbind_output  : ${params.diffbind_output}"
    log.info "  container_diffbind: ${params.container_diffbind}"

    if ( !file(params.samplesheet).exists() ) {
        error "Sample sheet not found: ${params.samplesheet}"
    }

    diffbind_run( file(params.samplesheet) )
}
